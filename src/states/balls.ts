...
const useBalls = create<IBallsState>((set) => ({
  ...
  pendingBalls: [],
  addBall: (blockNumber: string) => set((state) => ({
  ...
  addPendingBall: (blockNumber: string) => set((state) => ({ pendingBalls: state.pendingBalls.find((ball) => ball.blockNumber === blockNumber) ? state.pendingBalls : [...state.pendingBalls, { blockNumber }] })),
  ...
  addBallFromPending: (blockNumber: string) => set((state) => ({
